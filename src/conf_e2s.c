...
element_to_sound[] =
{
  ...
  {
    EL_DEFAULT, TRUE,				ACTION_HITTING,
    SND_CLASS_DEFAULT_HITTING
  },
  {
  ...
  {
    EL_MM_DEFAULT, TRUE,			ACTION_EXPLODING,
    SND_CLASS_MM_DEFAULT_EXPLODING
  },
  {
  ...
  {
    EL_MM_MCDUFFIN_RIGHT, TRUE,			ACTION_HITTING,
    SND_CLASS_MM_MCDUFFIN_HITTING
  },
  {
    EL_MM_MIRROR_1, TRUE,			ACTION_HITTING,
    SND_CLASS_MM_MIRROR_HITTING
  },
  {
    EL_MM_MIRROR_FIXED_1, TRUE,			ACTION_HITTING,
    SND_CLASS_MM_MIRROR_FIXED_HITTING
  },
  {
    EL_MM_PRISM, TRUE,				ACTION_HITTING,
    SND_CLASS_MM_PRISM_HITTING
  },
  {
    EL_MM_EXIT_CLOSED, TRUE,			ACTION_HITTING,
    SND_CLASS_MM_EXIT_HITTING
  },
  {
    EL_MM_EXIT_CLOSED, TRUE,			ACTION_OPENING,
    SND_CLASS_MM_EXIT_OPENING
  },
  {
    EL_MM_EXIT_OPEN, FALSE,			ACTION_HITTING,
    SND_MM_EXIT_OPEN_HITTING
  },
  {
    EL_DF_MIRROR_1, TRUE,			ACTION_HITTING,
    SND_CLASS_DF_MIRROR_HITTING
  },
  {
    EL_DF_MIRROR_ROTATING_1, TRUE,		ACTION_HITTING,
    SND_CLASS_DF_MIRROR_ROTATING_HITTING
  },
  {
    EL_DF_REFRACTOR, TRUE,			ACTION_HITTING,
    SND_CLASS_DF_REFRACTOR_HITTING
  },
  {
    EL_DF_RECEIVER_RIGHT, TRUE,			ACTION_HITTING,
    SND_CLASS_DF_RECEIVER_HITTING
  },
  {
    EL_DF_RECEIVER_RIGHT, TRUE,			ACTION_OPENING,
    SND_CLASS_DF_RECEIVER_OPENING
  },
  {
    EL_MM_WOODEN_WALL_1, TRUE,			ACTION_HITTING,
    SND_CLASS_MM_WOODEN_WALL_HITTING
  },
  {
    EL_MM_WOODEN_BLOCK, TRUE,			ACTION_HITTING,
    SND_CLASS_MM_WOODEN_BLOCK_HITTING
  },
  {
    EL_MM_WOODEN_BLOCK, TRUE,			ACTION_PUSHING,
    SND_CLASS_MM_WOODEN_BLOCK_PUSHING
  },
  {
    EL_MM_WOODEN_LOCK, TRUE,			ACTION_HITTING,
    SND_CLASS_MM_WOODEN_LOCK_HITTING
  },
  {
    EL_MM_WOODEN_GRID_FIXED_1, TRUE,		ACTION_HITTING,
    SND_CLASS_MM_WOODEN_GRID_FIXED_HITTING
  },
  {
    EL_MM_FUSE_ACTIVE, TRUE,			ACTION_HITTING,
    SND_CLASS_MM_FUSE_HITTING
  },
  {
    EL_MM_ICE_WALL_1, TRUE,			ACTION_HITTING,
    SND_CLASS_MM_ICE_WALL_HITTING
  },
  {
    EL_MM_ICE_WALL_1, TRUE,			ACTION_SHRINKING,
    SND_CLASS_MM_ICE_WALL_SHRINKING
  },
  {
    EL_MM_AMOEBA_WALL_1, TRUE,			ACTION_HITTING,
    SND_CLASS_MM_AMOEBA_WALL_HITTING
  },
  {
    EL_MM_AMOEBA_WALL_1, TRUE,			ACTION_GROWING,
    SND_CLASS_MM_AMOEBA_WALL_GROWING
  },
  {
    EL_DF_WOODEN_WALL_1, TRUE,			ACTION_HITTING,
    SND_CLASS_DF_WOODEN_WALL_HITTING
  },
  {
    EL_DF_WOODEN_GRID_FIXED_1, TRUE,		ACTION_HITTING,
    SND_CLASS_DF_WOODEN_GRID_FIXED_HITTING
  },
  {
    EL_DF_WOODEN_GRID_ROTATING_1, TRUE,		ACTION_HITTING,
    SND_CLASS_DF_WOODEN_GRID_ROTATING_HITTING
  },
  {
    EL_MM_STEEL_WALL_1, TRUE,			ACTION_HITTING,
    SND_CLASS_MM_STEEL_WALL_HITTING
  },
  {
    EL_MM_STEEL_GRID_FIXED_1, TRUE,		ACTION_HITTING,
    SND_CLASS_MM_STEEL_GRID_FIXED_HITTING
  },
  {
    EL_MM_STEEL_BLOCK, TRUE,			ACTION_HITTING,
    SND_CLASS_MM_STEEL_BLOCK_HITTING
  },
  {
    EL_MM_STEEL_BLOCK, TRUE,			ACTION_PUSHING,
    SND_CLASS_MM_STEEL_BLOCK_PUSHING
  },
  {
    EL_MM_STEEL_LOCK, TRUE,			ACTION_HITTING,
    SND_CLASS_MM_STEEL_LOCK_HITTING
  },
  {
    EL_DF_STEEL_WALL_1, TRUE,			ACTION_HITTING,
    SND_CLASS_DF_STEEL_WALL_HITTING
  },
  {
    EL_DF_STEEL_GRID_FIXED_1, TRUE,		ACTION_HITTING,
    SND_CLASS_DF_STEEL_GRID_FIXED_HITTING
  },
  {
    EL_DF_STEEL_GRID_ROTATING_1, TRUE,		ACTION_HITTING,
    SND_CLASS_DF_STEEL_GRID_ROTATING_HITTING
  },
  {
    EL_MM_PACMAN_RIGHT, TRUE,			ACTION_EXPLODING,
    SND_CLASS_MM_PACMAN_EXPLODING
  },
  {
    EL_MM_MCDUFFIN_RIGHT, TRUE,			ACTION_EXPLODING,
    SND_CLASS_MM_MCDUFFIN_EXPLODING
  },
  {
    EL_MM_BOMB, TRUE,				ACTION_EXPLODING,
    SND_CLASS_MM_BOMB_EXPLODING
  },
  {
    EL_MM_KEY, TRUE,				ACTION_EXPLODING,
    SND_CLASS_MM_KEY_EXPLODING
  },
  {
    EL_MM_STEEL_LOCK, TRUE,			ACTION_EXPLODING,
    SND_CLASS_MM_STEEL_LOCK_EXPLODING
  },
  {
    EL_MM_WOODEN_LOCK, TRUE,			ACTION_EXPLODING,
    SND_CLASS_MM_WOODEN_LOCK_EXPLODING
  },
  {
    -1, -1,					-1,
    -1
