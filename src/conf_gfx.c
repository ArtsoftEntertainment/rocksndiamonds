...
#include "conf_emp.c"	// include auto-generated data structure definitions
  ...
  { "menu.bottom_spacing.INFO",				"32"				},
  { "menu.bottom_spacing.INFO[TITLE]",			"32"				},
  { "menu.bottom_spacing.INFO[ELEMENTS]",		"32"				},
  { "menu.bottom_spacing.INFO[MUSIC]",			"32"				},
  { "menu.bottom_spacing.INFO[CREDITS]",		"32"				},
  { "menu.bottom_spacing.INFO[PROGRAM]",		"32"				},
