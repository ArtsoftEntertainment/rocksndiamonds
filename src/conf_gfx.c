...
#include "conf_emp.c"	// include auto-generated data structure definitions
  ...
  { "menu.line_height.NAMES",				"-1"				},
  { "menu.line_height.LEVELS",				"-1"				},
  { "menu.line_height.LEVELNR",				"-1"				},
  { "menu.line_height.SCORES",				"-1"				},
  { "menu.line_height.SCOREINFO",			"-1"				},
  { "menu.line_height.INFO",				"-1"				},
  { "menu.line_height.INFO[TITLE]",			"-1"				},
  { "menu.line_height.INFO[ELEMENTS]",			"-1"				},
  { "menu.line_height.INFO[MUSIC]",			"-1"				},
  { "menu.line_height.INFO[CREDITS]",			"-1"				},
  { "menu.line_height.INFO[PROGRAM]",			"-1"				},
  { "menu.line_height.INFO[VERSION]",			"-1"				},
  { "menu.line_height.INFO[LEVELSET]",			"-1"				},
  { "menu.line_height.INFO[LEVEL]",			"-1"				},
  { "menu.line_height.INTRO",				"-1"				},
  { "menu.line_height.STORY",				"-1"				},
  { "menu.line_height.SETUP",				"-1"				},
  { "menu.line_height.SETUP[INPUT]",			"-1"				},
