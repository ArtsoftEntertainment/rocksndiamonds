...
static void CopyNativeLevel_RND_to_BD(struct LevelInfo *level)
{
  ...
  cave->open_borders_vertical		= level->bd_open_borders_vertical;
...
static void CopyNativeLevel_BD_to_RND(struct LevelInfo *level)
{
  ...
  level->bd_open_borders_vertical	= cave->open_borders_vertical;
...
static struct TokenInfo global_setup_tokens[] =
{
  ...
  { TYPE_SWITCH_3,	&setup.allow_skipping_levels,		"allow_skipping_levels"		},
  ...
  { TYPE_SWITCH_3,	&setup.bd_smooth_movements,		"bd_smooth_movements"		},
  { TYPE_SWITCH_3,	&setup.bd_pushing_graphics,		"bd_pushing_graphics"		},
  { TYPE_SWITCH_3,	&setup.bd_up_down_graphics,		"bd_up_down_graphics"		},
  { TYPE_SWITCH_3,	&setup.bd_falling_sounds,		"bd_falling_sounds"		},
  ...
  { TYPE_SWITCH_3,	&setup.override_level_graphics,		"override_level_graphics"	},
  { TYPE_SWITCH_3,	&setup.override_level_sounds,		"override_level_sounds"		},
  { TYPE_SWITCH_3,	&setup.override_level_music,		"override_level_music"		},
...
static struct TokenInfo debug_setup_tokens[] =
{
  ...
  { TYPE_SWITCH_3,	&setup.debug.xsn_mode,			"debug.xsn_mode"		},
...
static void LoadMenuDesignSettingsFromFilename(char *filename)
{
  ...
  for (i = 0; i < NUM_SPECIAL_GFX_INFO_ARGS; i++)
  {
    struct TokenIntPtrInfo menu_config[] =
    {
      ...
      { "menu.use_scrollbar2.INFO",	&menu.use_scrollbar2_info[i]	},
