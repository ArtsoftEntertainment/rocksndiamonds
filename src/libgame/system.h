...
struct SetupInfo
{
  ...
  boolean bd_zigzag_movement;
  boolean em_zigzag_movement;
  boolean sp_zigzag_movement;
...
struct TreeInfo
{
  ...
  boolean skip_intros;		// intros will be skipped when set to "true"
