...
void InitElementProperties_MM()
{
  ...
  static int ep_reflecting_num = 0; /*#HAG#EMPTYARRAY#*//* sizeof(ep_reflecting) / sizeof(int); */

  static int ep_absorbing[] =
  {
    0	/*#HAG#EMPTYRECORD#*/
  };
  static int ep_absorbing_num = 0;  /*#HAG#EMPTYRECORD#*//* sizeof(ep_absorbing) / sizeof(int); */

  static int ep_inactive[] =
  {
    0	/*#HAG#EMPTYRECORD#*/
  };
  static int ep_inactive_num = 0;   /*#HAG#EMPTYRECORD#*//* sizeof(ep_inactive) / sizeof(int); */

  static int ep_wall[] =
  {
    0	/*#HAG#EMPTYRECORD#*/
  };
  static int ep_wall_num = 0;	    /*#HAG#EMPTYRECORD#*//* sizeof(ep_wall) / sizeof(int); */
